...
- [Braze Web SDK Documentation](https://js.appboycdn.com/web-sdk/5.6/doc/modules/braze.html)

## Libraries

| Name | Description | npm | CDN URL
| ---- | ----------- | --- | -------
| Full | Full SDK with UI. When using the npm version, Javascript bundlers will remove any unused code including the UI. | `@braze/web-sdk` | https://js.appboycdn.com/web-sdk/5.6/braze.min.js
...
so remove this option or [provide an alternate logger](https://js.appboycdn.com/web-sdk/5.6/doc/modules/braze.html#setlogger) before you release your page to production.
