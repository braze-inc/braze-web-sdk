...
- [Read the full technical documentation](https://js.appboycdn.com/web-sdk/1.4/doc/module-appboy.html)
...
**Be sure to replace "YOUR-API-KEY-HERE" with your API key!** Note that you'll still need to load the [css](https://js.appboycdn.com/web-sdk/1.4/appboy.min.css) (ideally self-hosted alongside the Javascript) in the `<head>` section of your page.
...
of the complete library instead. The core library is available at `https://js.appboycdn.com/web-sdk/1.4/appboy.core.min.js`.
