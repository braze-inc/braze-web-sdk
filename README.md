...
- [Braze Web SDK Documentation](https://js.appboycdn.com/web-sdk/5.8/doc/modules/braze.html)
...
| No-AMD | Contains the full SDK without AMD support. This is useful if your site uses RequireJS or another AMD module-loader, but you prefer to load the SDK through the CDN. | N/A | https://js.appboycdn.com/web-sdk/5.8/braze.no-amd.min.js
...
so remove this option or [provide an alternate logger](https://js.appboycdn.com/web-sdk/5.8/doc/modules/braze.html#setlogger) before you release your page to production.
