...
##### Added
- Added [`braze.dismissBanner()`](https://js.appboycdn.com/web-sdk/latest/doc/modules/braze.html#dismissbanner), which can be used to programmatically dismiss a banner and log a dismissal event.
- Added [`Banner.subscribeToDismissedEvent()`](https://js.appboycdn.com/web-sdk/latest/doc/classes/braze.banner.html#subscribetodismissedevent), which can be used to subscribe to dismissal events for a Banner.
...
- Added `imageAltText` and `language` fields to the following classes:
  - Cards: [`CaptionedImage`](https://js.appboycdn.com/web-sdk/latest/doc/classes/braze.captionedimage.html), [`ImageOnly`](https://js.appboycdn.com/web-sdk/latest/doc/classes/braze.imageonly.html), and [`ClassicCard`]
  - In-App Messages: [`ModalMessage`](https://js.appboycdn.com/web-sdk/latest/doc/classes/braze.modalmessage.html), [`FullScreenMessage`](https://js.appboycdn.com/web-sdk/latest/doc/classes/braze.fullscreenmessage.html), and [`SlideUpMessage`](https://js.appboycdn.com/web-sdk/latest/doc/classes/braze.slideupmessage.html)
